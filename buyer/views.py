...
from core.mixins import IsBuyerMixin
# Create your views here.

class BuyerDashboardView(LoginRequiredMixin, IsBuyerMixin, View):
    def get(self, request, *args, **kwargs):
        return render(request, 'buyer/dashboard.html')


class CustomPasswordChangeView(LoginRequiredMixin, IsBuyerMixin, PasswordChangeView):
