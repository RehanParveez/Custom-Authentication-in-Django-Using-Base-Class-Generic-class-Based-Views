...
class UserModelAdmin(UserAdmin):
    ...
    list_display = ["id", "email", "name", "is_active", "is_superuser", "is_staff", "is_buyer", "is_seller"]
    list_filter = ["is_superuser"]
    fieldsets = [
        ("User Credentials", {"fields": ["email", "password"]}),
        ("Personal Information", {"fields": ["name", "city"]}),
        ("Permissions", {"fields": [
        "is_active", "is_staff", "is_superuser", "is_buyer", "is_seller"]})
    ]
...
add_fieldsets = [
    (
        ...
        None,
        {
            ...
            # Its a css class to make full width admin layout
            "classes": ["wide"],
            #1 This fields will appear in admin panel add user form
